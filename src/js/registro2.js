document.addEventListener('DOMContentLoaded', function () {
    ...
    const activeUser = JSON.parse(localStorage.getItem('activeUser')); // Obtener usuario activo
    ...
    const userId = activeUser.username; // Utilizamos el nombre de usuario como identificador único

    let periodDays = JSON.parse(localStorage.getItem(`${userId}_periodDays`)) || [];
    let predictions = JSON.parse(localStorage.getItem(`${userId}_predictions`)) || [];
    let ovulationDays = JSON.parse(localStorage.getItem(`${userId}_ovulationDays`)) || [];
    ...
    function sendMessage(nextCycleDate) {
        ...
        let messages = JSON.parse(localStorage.getItem(`${userId}_messages`)) || [];
    ...
    function clearMessages() {
        localStorage.removeItem(`${userId}_messages`);
    }
    ...
    function savePeriodDays() {
        localStorage.setItem(`${userId}_periodDays`, JSON.stringify(periodDays));
    }

    function savePredictions() {
        localStorage.setItem(`${userId}_predictions`, JSON.stringify(predictions));
    }

    function saveOvulationDays() {
        localStorage.setItem(`${userId}_ovulationDays`, JSON.stringify(ovulationDays));
    }
